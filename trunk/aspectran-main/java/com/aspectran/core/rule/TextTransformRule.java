 ...
 */
public class TextTransformRule extends TransformRule {
	
	/**
	 * Instantiates a new text transform rule.
	 */
	public TextTransformRule() {
		super.transformType = TransformType.TEXT_TRANSFORM;
	}	
