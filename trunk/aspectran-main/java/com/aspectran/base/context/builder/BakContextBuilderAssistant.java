...
public class BakContextBuilderAssistant {
	...
	private List<Resource> beanMapResources;

	/** The translet map resources. */
	private List<Resource> transletMapResources;
	...
	public BakContextBuilderAssistant() {
		this.transletMapResources = new ArrayList<Resource>();
	 ...
	 */
	public List<Resource> getBeanMapResources() {
	 ...
	 */
	public void addBeanMapResource(Resource mapResource) {
		if(beanMapResources == null)
			beanMapResources = new ArrayList<Resource>();
	 ...
	 */
	public List<Resource> getTransletMapResources() {
	 ...
	 * @param mapResource the map resource
	 */
	public void addTransletMapResource(Resource mapResource) {
		if(transletMapResources == null)
			transletMapResources = new ArrayList<Resource>();
