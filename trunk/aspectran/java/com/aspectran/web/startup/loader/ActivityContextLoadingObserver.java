...
public class ActivityContextLoadingObserver extends ActivityContextLoader implements ActivityContextReloadable {

	private ActivityContextReloadingHandler activityContextReloadingHandler;
	
	private String[] observingPaths;
	
	public ActivityContextLoadingObserver(ServletContext servletContext, String contextConfigLocation) {
		super(servletContext, contextConfigLocation);
	}
	
	public ActivityContextLoadingObserver(ServletContext servletContext, String contextConfigLocation, ClassLoader classLoader) {
