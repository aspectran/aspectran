...
/**
 * Test helper bean to inspect the active SLF4J MDC logging group during request execution.
 */
public class LoggingGroupInspector {

    public String getCurrentLoggingGroup() {
