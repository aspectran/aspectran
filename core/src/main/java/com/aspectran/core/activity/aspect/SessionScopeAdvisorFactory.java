...
/**
 * The Class SessionScopeAdvisorFactory.
 */
public class SessionScopeAdvisorFactory {

    private static final Log log = LogFactory.getLog(SessionScopeAdvisorFactory.class);
