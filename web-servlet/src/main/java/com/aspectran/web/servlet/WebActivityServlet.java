...
import com.aspectran.web.servlet.listener.WebServiceListener;
 ...
 * {@link WebServiceListener}) or creates its own.
...
public class WebActivityServlet extends HttpServlet implements Servlet {
    ...
    public void init() throws ServletException {
        try {
            DefaultServletWebService rootWebService = null;
            try {
                rootWebService = ServletWebService.findWebService(getServletContext());
            } catch (IllegalStateException e) {
                // ignored
            }

            DefaultServletWebService newWebService;
            if (rootWebService != null) {
                newWebService = DefaultServletWebServiceBuilder.build(this, rootWebService);
                ...
                newWebService = DefaultServletWebServiceBuilder.build(this);
                this.standalone = true;
            }
            if (newWebService != null) {
