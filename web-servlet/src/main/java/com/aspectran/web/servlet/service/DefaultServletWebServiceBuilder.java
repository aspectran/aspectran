 ...
 */
package com.aspectran.web.servlet.service;
...
import com.aspectran.web.servlet.websocket.jsr356.ServerEndpointExporter;
...
/**
 * A builder class for creating and configuring {@link DefaultServletWebService} instances.
 ...
 * </p>
 */
public class DefaultServletWebServiceBuilder {

    private static final Logger logger = LoggerFactory.getLogger(DefaultServletWebServiceBuilder.class);

    private static final String ASPECTRAN_CONFIG_PARAM = "aspectran:config";

    /**
     * Builds a new {@link DefaultServletWebService} instance for the given {@link ServletContext}.
     * @param servletContext the servlet context
     * @return a new, configured {@code DefaultWebService} instance
     */
    @NonNull
    public static DefaultServletWebService build(ServletContext servletContext) {
        return build(servletContext, null);
    }

    /**
     * Builds a new {@link DefaultServletWebService} instance for the given {@link ServletContext} and parent service.
     * @param servletContext the servlet context
     * @param parentService the parent service (optional)
     * @return a new, configured {@code DefaultWebService} instance
     */
    @NonNull
    public static DefaultServletWebService build(ServletContext servletContext, CoreService parentService) {
        ...
        DefaultServletWebService webService;
        ...
        ServletWebService.bind(servletContext, webService);
        return webService;
    }

    /**
     * Builds a new {@link DefaultServletWebService} instance from a {@link WebActivityServlet}.
     * @param servlet the web activity servlet
     * @return a new, configured {@code DefaultWebService} instance
     */
    @Nullable
    public static DefaultServletWebService build(WebActivityServlet servlet) {
        return build(servlet, null);
    }

    /**
     * Builds a new {@link DefaultServletWebService} instance from a {@link WebActivityServlet} and a root web service.
     * @param servlet the web activity servlet
     * @param rootWebService the root web service (optional)
     * @return a new, configured {@code DefaultWebService} instance
     */
    @Nullable
    public static DefaultServletWebService build(WebActivityServlet servlet, WebService rootWebService) {
    ...
    /**
     * Internal helper method to build a derived {@link DefaultServletWebService}.
     * @param servletContext the servlet context
     * @param parentService the parent service
     * @return a new, configured derived {@code DefaultWebService} instance
     */
    @NonNull
    private static DefaultServletWebService doBuild(ServletContext servletContext, @NonNull CoreService parentService) {
        DefaultServletWebService webService = new DefaultServletWebService(servletContext, parentService, true);
    ...
    /**
     * Internal helper method to build a new {@link DefaultServletWebService}.
     * @param servletContext the servlet context
     * @param parentService the parent service (optional)
     ...
     */
    @NonNull
    private static DefaultServletWebService doBuild(
            ServletContext servletContext,
            @Nullable CoreService parentService,
            @NonNull AspectranConfig aspectranConfig) {
        DefaultServletWebService webService = new DefaultServletWebService(servletContext, parentService, false);
    ...
    private static void setServiceStateListener(@NonNull DefaultServletWebService webService) {
