 ...
 * </p>
 */
public class DefaultServletWebService extends AbstractServletWebService {

    private static final Logger logger = LoggerFactory.getLogger(DefaultServletWebService.class);

    protected volatile long pauseTimeout = -2L;

    DefaultServletWebService(@NonNull ServletContext servletContext, @Nullable CoreService parentService, boolean derived) {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ServletWebActivity activity = new ServletWebActivity(this, getContextPath(), reverseContextPath, request, response);
        ...
        ServletWebService.bind(activity, this);
    ...
    private void asyncPerform(@NonNull ServletWebActivity activity) {
    ...
    private void perform(@NonNull ServletWebActivity activity) {
    ...
    private void transletNotFound(@NonNull ServletWebActivity activity) {
    ...
    private void sendError(@NonNull ServletWebActivity activity, Exception e) {
        Throwable t;
