 ...
 */
package com.aspectran.web.servlet.support.tags;

import com.aspectran.utils.Assert;
import com.aspectran.utils.StringUtils;
import com.aspectran.web.servlet.support.util.TagUtils;
 ...
 * replaced by the URL encoded value of a parameter defined with the aspectran:param tag
 ...
 * string.
 *
 * <p>Use of the aspectran:param tag for URI template variables is strongly recommended
 ...
 * <p>Example usage:
 * <pre class="code">
 * &lt;aspectran:url value="/url/path/{variableName}"&gt;
 *   &lt;aspectran:param name="variableName" value="more than JSTL c:url" /&gt;
 * &lt;/aspectran:url&gt;</pre>
 *
