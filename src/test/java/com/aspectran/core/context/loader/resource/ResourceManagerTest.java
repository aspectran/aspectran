...
public class ResourceManagerTest {
	...
	public static Enumeration<URL> getResources(final Iterator<AspectranClassLoaderTest> owners) {
	...
	public static Enumeration<URL> getResources(final Iterator<AspectranClassLoaderTest> owners, String name) {
		return getResources(owners, name, null);
	}
	
	public static Enumeration<URL> getResources(final Iterator<AspectranClassLoaderTest> owners, String name, final Enumeration<URL> inherited) {
	...
	public static Enumeration<URL> searchResources(final Iterator<AspectranClassLoaderTest> owners, String name) {
		return searchResources(owners, name, null);
	}

	public static Enumeration<URL> searchResources(final Iterator<AspectranClassLoaderTest> owners, String name, final Enumeration<URL> inherited) {
		if(name.endsWith(ResourceUtils.RESOURCE_NAME_SPEPARATOR))
			name = name.substring(0, name.length() - 1);
