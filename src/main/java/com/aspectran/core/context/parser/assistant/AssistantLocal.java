...
public class AssistantLocal implements Replicable<AssistantLocal> {
    ...
    private ContextParserAssistant assistant;
    ...
    public AssistantLocal(ContextParserAssistant assistant) {
        this(assistant, 0);
    }

    private AssistantLocal(ContextParserAssistant assistant, int replicatedCount) {
        this.assistant = assistant;
        this.replicatedCount = replicatedCount;
    }

    public ContextParserAssistant getAssistant() {
        return assistant;
    }
