...
import com.aspectran.core.context.parser.importer.ShallowImportHandler;
 ...
 */
public class ShallowContextParserAssistant extends ContextParserAssistant {
    ...
    public ShallowContextParserAssistant() {
        super();
    }
