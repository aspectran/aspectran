...
class AspectranDtdResolver implements EntityResolver {
	...
	private static final String ASPECTRAN_DTD = "/com/aspectran/core/context/builder/xml/dtd/aspectran-2.dtd";
	...
	static {
		...
		doctypeMap.put("aspectran-2.dtd".toUpperCase(), ASPECTRAN_DTD);
	}
