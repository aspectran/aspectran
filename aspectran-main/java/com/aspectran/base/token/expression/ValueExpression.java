 ...
 */
package com.aspectran.base.token.expression;
 ...
 */
public class ValueExpression extends TokenExpression implements ValueExpressor {
	 ...
	 */
	public ValueExpression(BeanRegistry beanRegistry) {
		super(beanRegistry);
	}
