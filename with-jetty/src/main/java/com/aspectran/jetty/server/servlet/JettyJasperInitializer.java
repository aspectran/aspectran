 ...
 */
public class JettyJasperInitializer extends JasperInitializer implements ActivityContextAware {

    private static final Logger logger = LoggerFactory.getLogger(JettyJasperInitializer.class);
