 ...
 */
package com.aspectran.jpa.test.simple;
...
class EclipseLinkJpaTest {
    ...
    void ready() throws Exception {
        ...
        File configFile = ResourceUtils.getResourceAsFile("com/aspectran/jpa/test/simple/aspectran-config-eclipselink.apon");
