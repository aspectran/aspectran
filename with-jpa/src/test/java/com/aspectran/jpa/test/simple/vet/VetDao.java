 ...
 */
package com.aspectran.jpa.test.simple.vet;

import com.aspectran.core.component.bean.annotation.Autowired;
import com.aspectran.core.component.bean.annotation.Component;
import com.aspectran.jpa.test.common.model.QVet;
import com.aspectran.jpa.test.common.model.Vet;
import com.aspectran.jpa.test.common.pagination.PageInfo;
...
public class VetDao {
    ...
    private final VetEntityQuery entityQuery;

    @Autowired
    public VetDao(VetEntityQuery entityQuery) {
